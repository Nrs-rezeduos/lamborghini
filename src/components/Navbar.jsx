...
const ownershipLinks = [
  ...
  { label: 'UNICA', path: '/unica' },
  { label: 'MOBILITY PROGRAM', path: '/mobility-program' },
  { label: 'CLASSICS', path: '/classics' },
  { label: 'DEFEAT TIME', path: '/defeat-time' },
  { label: 'SERVICE', path: '/service' },
  { label: 'RECALL CAMPAIGN', path: '/recall-campaign' },
]
          ...
          <>
            <div className="menu-main-links">
              {mainLinks.map((link, i) => {
                if (link.label === 'OWNERSHIP') {
                  return (
                    <button
                      key={i}
                      className="main-link ownership-button"
